...
public class PressToolServerSpringProxyFactory extends AbstractPressTool implements FactoryBean<Object>, MethodInterceptor, InitializingBean {
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		return doInvoke(serviceOriginal, invocation.getMethod(), invocation.getArguments());
	}
