...
@ContextConfiguration(locations = {
		"classpath:org/fl/noodlecall/core/server/net/export/noodlecall-core-server-net-exporter-netty-json.xml",
		"classpath:org/fl/noodlecall/core/client/net/refer/noodlecall-core-client-net-proxyfactory.xml"
})
public class ServiceProxyFactoryNettyJsonTest extends AbstractJUnit4SpringContextTests {
