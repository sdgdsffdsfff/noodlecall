...
@ContextConfiguration(locations = {
		"classpath:org/fl/noodlecall/core/server/net/export/noodlecall-core-server-net-exporter.xml",
		"classpath:org/fl/noodlecall/core/client/net/refer/noodlecall-core-client-net-proxyfactory.xml"
})
public class ServiceProxyFactoryTest extends AbstractJUnit4SpringContextTests {
