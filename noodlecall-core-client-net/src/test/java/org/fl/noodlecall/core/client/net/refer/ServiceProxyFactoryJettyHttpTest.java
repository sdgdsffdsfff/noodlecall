...
@ContextConfiguration(locations = {
		"classpath:org/fl/noodlecall/core/server/net/export/noodlecall-core-server-net-exporter-jetty-json.xml",
		"classpath:org/fl/noodlecall/core/client/net/refer/noodlecall-core-client-net-proxyfactory.xml"
})
public class ServiceProxyFactoryJettyHttpTest extends AbstractJUnit4SpringContextTests {
