...
@ContextConfiguration(locations = {
		"classpath:org/fl/noodlecall/core/server/net/export/noodlecall-core-server-net-exporter-servlet-json.xml",
		"classpath:org/fl/noodlecall/core/client/net/refer/noodlecall-core-client-net-proxyfactory.xml"
})
public class ServiceProxyFactoryServletJsonTest extends AbstractJUnit4SpringContextTests {
