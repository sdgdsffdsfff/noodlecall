  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function init() {
			...
			$('#list_left').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/service/group/queryincludepage',
				datatype: 'json',
				mtype: 'post',
				...
				colNames: [
			   	...
			   	colModel: [
					...
					{name:'serviceGroup_Id', index:'serviceGroup_Id', width:80, align:'center', hidden:true},
			...
			$('#list_right').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/service/group/queryexcludepage',
				datatype: 'json',
				mtype: 'post',
				postData:{'input': jsonToString(paramObject)}, 
				colNames: [
		...
		function inserts() {
			...
			transaction({
				id: 'INSERTS',
				url: '<%=request.getContextPath()%>/console/service/group/inserts',
				jsonSet: jsonSet
			});	
		}
		...
		function deletes() {
			...
			transaction({
				id: 'DELETES',
				url: '<%=request.getContextPath()%>/console/service/group/deletes',
				jsonSet: jsonSet
			});	
		}
