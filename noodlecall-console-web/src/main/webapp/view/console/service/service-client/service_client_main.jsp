  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function init() {
			...
			$('#list_left').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/client/queryincludeservicepage',
				datatype: 'json',
				mtype: 'post',
			...
			$('#list_right').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/client/queryexcludeservicepage',
				datatype: 'json',
				mtype: 'post',
				postData:{'input': jsonToString(paramObject)}, 
				colNames: [
		...
		function inserts() {
			...
			transaction({
				id: 'INSERTS',
				url: '<%=request.getContextPath()%>/console/client/insertsservice',
				jsonSet: jsonSet
			});	
		}
		...
		function deletes() {
			...
			transaction({
				id: 'DELETES',
				url: '<%=request.getContextPath()%>/console/client/deletesservice',
				jsonSet: jsonSet
			});	
		}
