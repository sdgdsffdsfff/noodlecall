  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function init() {
			...
			$('#list_left').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/server/queryincludegrouppage',
				datatype: 'json',
				mtype: 'post',
			...
			$('#list_right').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/server/queryexcludegrouppage',
				datatype: 'json',
				mtype: 'post',
				postData:{'input': jsonToString(paramObject)}, 
				colNames: [
		...
		function inserts() {
			...
			transaction({
				id: 'INSERTS',
				url: '<%=request.getContextPath()%>/console/server/insertsgroup',
				jsonSet: jsonSet
			});	
		}
		...
		function deletes() {
			...
			transaction({
				id: 'DELETES',
				url: '<%=request.getContextPath()%>/console/server/deletesgroup',
				jsonSet: jsonSet
			});	
		}
